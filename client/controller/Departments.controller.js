...
sap.ui.define([
  ...
  return Controller.extend('tms.basic.controller.Departments', {
    onInit: function() {},
    ...
    update: function() {
      let that = this;
      let oModel = that.getOwnerComponent().getModel('Departments');
      oModel.loadData(
        $.sap.formatMessage(
          '{0}Departments',
    ...
    onPress: function(oEvent) {
      let that = this;
      let oBindingContext = oEvent.getSource().getBindingContext('Departments');
