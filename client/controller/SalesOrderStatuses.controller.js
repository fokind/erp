...
sap.ui.define([
  ...
  return Controller.extend('tms.basic.controller.SalesOrderStatuses', {
    onInit: function() {
      let that = this;
      that.aConfigModels = [];
    ...
    onItemPress: function(oEvent) {
      ...
      oRouter.navTo('sales-order-status', {
        id: o._id,
      });
    },
    ...
    onAddActionPress: function(oControlEvent) {
      let that = this;
      let oBinding = that.byId("salesOrderStatuses").getBinding("items");
      ...
      oContext.created().then(() => {
        ...
        sap.ui.core.UIComponent.getRouterFor(that).navTo('sales-order-status', {id: sId});
      });
    },
